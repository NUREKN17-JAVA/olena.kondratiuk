...
import ua.nure.cs.kondratiuk.usermanagement.agent.SearchAgent;
import ua.nure.cs.kondratiuk.usermanagement.agent.SearchException;
...
public class SearchGui extends JFrame {
    ...
    private static final int Searcher = 0;
